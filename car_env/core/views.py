            ...
            if type == 'login':
                try:
                    ...
                    if user.mobile_verified:
                        ...
                        request.session['password'] = password
                        request.session['otp'] = otp
                        # text = ' Hi ' + str(user.first_name) + ', Please use OTP ' + str(
                ...
                try:
                    ...
                    request.session['password'] = password
                    request.session['otp'] = otp
                    # text = ' Hi '+ str(full_name) + ', Please use OTP ' + str(otp) + ' to complete the registration process on travelchannels.in'
                    # SMS(mobile, text)
                    print('-----------------------OTP--------------------------')
                    print(otp)
                    customerprofile = customermodels.customerprofile.objects.create(user=user)
...
def payu_success(request):
    ...
    print(booking_qs.phone_no, message)
